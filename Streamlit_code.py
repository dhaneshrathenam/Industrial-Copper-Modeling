...
with tab1:
    ...
    if submit_button and flag == 0:
        ...
        with open(r"C:\Users\Dhanesh\Downloads\Project_5\source\model.pkl", 'rb') as file:
            loaded_model = pickle.load(file)
        with open(r'C:\Users\Dhanesh\Downloads\Project_5\source\scaler.pkl', 'rb') as f:
            scaler_loaded = pickle.load(f)

        with open(r"C:\Users\Dhanesh\Downloads\Project_5\source\t.pkl", 'rb') as f:
            t_loaded = pickle.load(f)

        with open(r"C:\Users\Dhanesh\Downloads\Project_5\source\s.pkl", 'rb') as f:
...
with tab2:
    ...
    if csubmit_button and cflag == 0:
        ...
        with open(r"C:\Users\Dhanesh\Downloads\Project_5\source\clsmodel.pkl", 'rb') as file:
            cloaded_model = pickle.load(file)

        with open(r'C:\Users\Dhanesh\Downloads\Project_5\source\cscaler.pkl', 'rb') as f:
            cscaler_loaded = pickle.load(f)

        with open(r"C:\Users\Dhanesh\Downloads\Project_5\source\ct.pkl", 'rb') as f:
...
st.write(f'<h6 style="color:rgb(0, 153, 153,0.35);">Created by Dhanesh </h6>', unsafe_allow_html=True)
